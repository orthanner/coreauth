...
create table users (id identity primary key not null, login varchar(32) unique not null, password varchar(128));
...
create table permission (id identity primary key not null, name varchar(128));
create table profile (id identity primary key not null, realm varchar(255) not null references realm(name), name varchar(64) unique not null);
